...
import { saveDeliverableTool, saveDeliverable } from './tools/save-deliverable.js';
import { generateTotpTool, generateTotp } from './tools/generate-totp.js';
...
export function createShannonHelperServer(targetDir) {
  ...
  return {
    ...
    version: '1.0.0',
    tools: [
      { ...saveDeliverableTool, handler: saveDeliverable },
      { ...generateTotpTool, handler: generateTotp }
    ],
  };
}
